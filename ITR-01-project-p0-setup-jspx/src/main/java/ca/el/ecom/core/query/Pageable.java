...
public class Pageable implements Serializable {
   ...
   private static final long serialVersionUID    = -5664169182624817224L;
   ...
   public boolean equals(Object obj) {
      ...
      return new EqualsBuilder().append(getPageNumber(), other.getPageNumber())
         ...
         .append(getSortProperty(), other.getSortProperty())
         .append(getSortDirection(), other.getSortDirection())
         .append(getFilters(), other.getFilters())
         .append(getSorts(), other.getSorts())
         .isEquals();
   }
   ...
   public int hashCode() {
      return new HashCodeBuilder(17, 37).append(getPageNumber())
         ...
         .append(getSortProperty())
         .append(getSortDirection())
         .append(getFilters())
         .append(getSorts())
         .toHashCode();
   }
