...
import com.el.ecom.service._BaseService;

public abstract class _BaseServiceImpl<T extends _BaseEntity<ID>, ID extends Serializable> implements _BaseService<T, ID> {
   private static final String[] UPDATE_IGNORE_PROPERTIES = new String[] { _BaseEntity.CREATE_DATE_PROPERTY_NAME,
      _BaseEntity.MODIFY_DATE_PROPERTY_NAME,
      _BaseEntity.VERSION_PROPERTY_NAME                  };
