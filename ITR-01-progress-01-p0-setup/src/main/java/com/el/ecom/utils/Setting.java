...
public class Setting implements Serializable {
   ...
   /** 缓存Key */
   public static final Integer   CACHE_KEY  = Integer.MAX_VALUE;
    ...
    * 设置商品缩略图宽度
    * 
    * @param thumbnailProductImageWidth 商品缩略图宽度
    */
    ...
    * 设置商品缩略图高度
    * 
    * @param thumbnailProductImageHeight 商品缩略图高度
    */
    ...
    * 设置默认商品图片(小)
    * 
    * @param defaultMediumProductImage 默认商品图片(小)
    */
    ...
    * 设置默认缩略图
    * 
    * @param defaultThumbnailProductImage 默认缩略图
    */
    ...
    * 设置SMTP是否启用SSL
    * 
    * @param smtpSSLEnabled SMTP是否启用SSL
    */
