...
public final class ImageUtils {
   ...
   public static void zoom(File srcFile, File destFile, int destWidth, int destHeight) {
      ...
      if (type == Type.jdk) {
         ...
         try {
            ...
            graphics2D.drawImage(srcBufferedImage.getScaledInstance(width, height, Image.SCALE_SMOOTH), (destWidth / 2) - (width / 2), (destHeight / 2)
               - (height / 2), null);
   ...
   public static void addWatermark(File srcFile, File destFile, File watermarkFile, WatermarkPosition watermarkPosition, int alpha) {
      ...
      if (watermarkFile == null || !watermarkFile.exists() || !watermarkFile.isFile() || watermarkPosition == null || watermarkPosition == WatermarkPosition.no) {
         try {
